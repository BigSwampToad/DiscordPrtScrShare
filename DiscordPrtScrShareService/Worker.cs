...
namespace DiscordPrtScrShareService
{
    public class Worker : BackgroundService, IDisposable
    {
        ...
        public Worker(ILogger<Worker> logger, string[] args)
        {
            ...
            _logger = logger;
            _logger.LogInformation("DiscordPrtScrShareService is initiating.");
            _input = new KeyboardInput();
            _input.KeyPressed += _input_KeyPressed;
            _logger.LogInformation($"DiscordPrtScrShareService KeyInput is : {_prtScrTriggerKey}, {(Key)_prtScrTriggerKey}");
        ...
        {
            _logger.LogInformation("DiscordPrtScrShareService is starting.");
        ...
        {
            _logger.LogInformation("DiscordPrtScrShareService is stopping.");
